...
AgentRouter.get("/referrals", AgentController.getAgentReferrals);
AgentRouter.get("/withdrawal", WalletController.getWithdrawalHistory);

AgentRouter.post("/request-withdrawal", WalletController.requestWithdrawal);

AgentRouter.put("/update-profile", AgentController.updateProfile); 
AgentRouter.put("/add-bank-details", AgentController.addBankDetails);
AgentRouter.put("/mark-notification-read", AgentController.markNotificationRead);
